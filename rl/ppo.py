    ...
    def get(self, batch_size):
        ...
        for start in range(0, total, batch_size):
            ...
            yield bi, flat_obs[bi], flat_act[bi], flat_lp[bi], flat_ret[bi], flat_adv[bi], \
                [flat_raw[i] for i in bi], [flat_vt[i] for i in bi], [flat_sh[i] for i in bi], [flat_si[i] for i in bi]
...
class PPOTrainer:
    ...
    def update(self, buffer):
        ...
        for _ in range(self.epochs):
            for bi, obs, acts, old_lps, _, _, _, vt_list, sh_list, si_list in buffer.get(self.batch_size):
                ...
                new_lps, ents, scnt = logprob_batched_combined(
                    ...
                    all_valid_targets=vt_list, all_source_ships=sh_list,
